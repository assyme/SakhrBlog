...
jQuery.formatNumber = function(number, options) {
    ...
    else
    {
        ...
        var firstGroupLength = 9999;
        if (onesFormat.lastIndexOf(",") != -1)
        {
            firstGroupLength = onesFormat.length - onesFormat.lastIndexOf(",")-1;
            if (onesFormat.lastIndexOf(",", onesFormat.lastIndexOf(",")-1) != -1)
                groupLength = onesFormat.lastIndexOf(",")-1 - onesFormat.lastIndexOf(",", onesFormat.lastIndexOf(",")-1);
             else
                groupLength = firstGroupLength;
        }
        var groupCount = 0;
        for (var i=oneText.length-1; i>-1; i--)
        {
            ...
            if (((onePortion.length > firstGroupLength && groupCount == groupLength) || groupCount == firstGroupLength) && i!=0)
            {
    ...
    returnString = ((ones < 0) ? neg : "") + onePortion + returnString;
